...
fn cases() {
    ...
    case(
        Value::Tuple(seq![
            ...
            Value::Enum(TypeId::Std(StdId { schema: 0x01, id: 0x5f50 }), 11),
            Value::Union(TypeId::Std(StdId { schema: 0x01, id: 0x5f49 }), 5, Box::new(Value::I64(5))),
            Value::Union(TypeId::Std(StdId { schema: 0xfe, id: 0x00aa }), 163, Box::new(Value::U64(12))),
